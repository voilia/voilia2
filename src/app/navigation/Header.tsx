...
export function Header({ toggleSidebar, isCollapsed }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 right-0 z-40 flex items-center justify-end w-full h-14 px-4 border-b border-border/40 backdrop-blur-md bg-background/80 transition-all duration-300" 
      style={{ 
